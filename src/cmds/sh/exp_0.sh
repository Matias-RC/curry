...
#SBATCH --job-name=maple_exp_0
#SBATCH --output=logs/exp_0.out
#SBATCH --error=logs/exp_0.err
#SBATCH --ntasks=1
...
CUDA_VISIBLE_DEVICES=1 python3 train.py \
    ...
    --output_dir behavioral-cloning/exp_00 \
...
CUDA_VISIBLE_DEVICES=2 python3 train.py \
    ...
    --num_epochs 100 \
    --where_to_save s3://rl6-reinforcement-learning-01 \
    --output_dir behavioral-cloning/exp_01 \
    --metrics_save_epoch_rate 10 \
    --verbose 1 
