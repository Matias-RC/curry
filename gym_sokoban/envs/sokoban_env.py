...
class SokobanEnv(gym.Env):
    ...
    def step(self, action, observation_mode='rgb_array'):
        ...
        if terminated or truncated:
            ...
            info["all_boxes_on_target"] = terminated
    ...
    def reset(self, seed=None, options=None, second_player=False, render_mode='rgb_array'):
        ...
        if seed is not None:
            ...
            # Also seed global random for room generation
            import random
            random.seed(seed)
            np.random.seed(seed)
    ...
    def render(self, mode=None, close=None, scale=1):
        if mode is None:
            mode = self.render_mode if self.render_mode is not None else 'rgb_array'
        ...
        if 'rgb_array' in mode:
            ...
            try:
                ...
                # Fallback if rendering is not available
                return img
