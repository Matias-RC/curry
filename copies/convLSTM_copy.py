...
class ConvLSTMCell(nn.Module):
    ...
    def forward(self, input_tensor: torch.Tensor, cur_state):
        ...
        gates = self.gate_conv((input_tensor, h_cur))  # conv_block must accept tuple
...
class ConvLSTM(nn.Module):
    ...
    def __init__(self, input_dim: int, hidden_dim: int, bias: bool = True,
        ...
        self.cell = ConvLSTMCell(input_dim=input_dim, hidden_dim=hidden_dim, bias=bias, conv_block=conv_block)

    def forward(self, input_tensor: torch.Tensor, hidden_state):
        h_prev, c_prev = hidden_state
        return self.cell(input_tensor, (h_prev, c_prev))
...
class StackedConvLSTM(nn.Module):
    ...
    def _build_layers(self):
        ...
        for layer_idx in range(self.num_layers):
            ...
            layer_module = ConvLSTM(input_dim=layer_in, hidden_dim=hidden_dim, bias=self.bias,
